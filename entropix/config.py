...
SAMPLER_CONFIGS = {
    "mlx-community/Llama-3.2-1B-Instruct-bf16": {
        ### actual values were too far from thresholds set in the entropix-local repo, adjusted using entropix/results/results_analysis.py after several runs
        "temperature": 0.666,
        "top_p": 0.90,
        "top_k": 27,
        "min_p": 0.03,
        "low_logits_entropy_threshold": 0.1,
        "medium_logits_entropy_threshold": 1.5,
        "high_logits_entropy_threshold": 2.1,
        "low_logits_varentropy_threshold": 0.3,
        "medium_logits_varentropy_threshold": 3.0,
        "high_logits_varentropy_threshold": 5.0,
        "low_attention_entropy_threshold": 2.4,
        "medium_attention_entropy_threshold": 2.75,
        "high_attention_entropy_threshold": 3.2,
        "low_attention_varentropy_threshold": 4.6,
        "medium_attention_varentropy_threshold": 6.75,
        "high_attention_varentropy_threshold": 8.5,
    ...
    "mlx-community/SmolLM2-360M-Instruct":{
        ### actual values were too far from thresholds set in SMOLLM x Entropix repo, adjusted using entropix/results/results_analysis.py after several runs
        "temperature": 0.666,
        "top_p": 0.90,
        "top_k": 27,
        "min_p": 0.03,
        "low_logits_entropy_threshold": 1.0,
        "medium_logits_entropy_threshold": 4.5,
        "high_logits_entropy_threshold": 6.0,
        "low_logits_varentropy_threshold": 1.0,
        "medium_logits_varentropy_threshold": 12.0,
        "high_logits_varentropy_threshold": 15.0,
        "low_attention_entropy_threshold": 1.75,
        "medium_attention_entropy_threshold": 3.5,
        "high_attention_entropy_threshold": 4.0,
        "low_attention_varentropy_threshold": 5.0,
        "medium_attention_varentropy_threshold": 9.5,
        "high_attention_varentropy_threshold": 12.0,
        "low_agreement_threshold": 1.8e-06,
        "medium_agreement_threshold": 3.8e-06,
        "high_agreement_threshold": 4.8e-06,
        "low_interaction_strength_threshold": 0.18,
    ...
    "mlx-community/Qwen2.5-0.5B-bf16":{
        ###values were set using entropix/results/results_analysis.py after several runs
        "temperature": 0.666,
        "top_p": 0.90,
        "top_k": 27,
        "min_p": 0.03,
        "low_logits_entropy_threshold": 2.0,
        "medium_logits_entropy_threshold": 5.0,
        "high_logits_entropy_threshold": 6.0,
        "low_logits_varentropy_threshold": 6.0,
        "medium_logits_varentropy_threshold": 12.0,
        "high_logits_varentropy_threshold": 14.0,
        "low_attention_entropy_threshold": 4.2,
        "medium_attention_entropy_threshold": 5.0,
        "high_attention_entropy_threshold": 5.85,
        "low_attention_varentropy_threshold": 2.2,
        "medium_attention_varentropy_threshold": 4.2,
        "high_attention_varentropy_threshold": 5.25,
        "low_agreement_threshold": 1.8e-06,
        "medium_agreement_threshold": 3.8e-06,
        "high_agreement_threshold": 4.8e-06,
        "low_interaction_strength_threshold": 0.18,
    ...
    "mlx-community/gemma-2-2b-it-fp16":{
        ...
        "top_k": 27,
        "min_p": 0.03,
        "low_logits_entropy_threshold": 0.75,
        "medium_logits_entropy_threshold": 1.9,
        "high_logits_entropy_threshold": 4.0,
        "low_logits_varentropy_threshold": 2.0,
        "medium_logits_varentropy_threshold": 5.0,
        "high_logits_varentropy_threshold": 9.0,
        "low_attention_entropy_threshold": 2.5,
        "medium_attention_entropy_threshold": 3.0,
        "high_attention_entropy_threshold": 3.5,
        "low_attention_varentropy_threshold": 5.9,
        "medium_attention_varentropy_threshold": 8.5,
        "high_attention_varentropy_threshold": 10.6,
        "low_agreement_threshold": 1.8e-06,
        "medium_agreement_threshold": 3.8e-06,
        "high_agreement_threshold": 4.8e-06,
        "low_interaction_strength_threshold": 0.18,
    ...
    "mlx-community/gemma-2-2b-fp16":{
        ### for now, same as 2b-it-fp16 above
        "temperature": 0.666,
        "top_p": 0.90,
        "top_k": 27,
        "min_p": 0.03,
    ...
    "mlx-community/Meta-Llama-3.1-70B-bf16": {
        ### using the same configuration as 1B for now
        "temperature": 0.666,
        "top_p": 0.90,
        "top_k": 27,
        "min_p": 0.03,
...
class EntropixSamplerConfig: 
    def __init__(self, model_path: str = DEFAULT_MODEL):
        ...
        self.model_path = model_path ### to keep track of the model when saving data
